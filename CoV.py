# | --                 CoV - Calculate of Variants                    -- |#
# | -- This app is designed to calculate individual homework variants -- |#
# | --                Designed by Poberezkin Nikita                   -- |#
...
def calculate_task():
    ...
    try:
        ...
        if (birth.year > today.year or (birth.year == today.year and birth.month > today.month) or (birth.year == today.year and birth.month == today.month and birth.day > today.day)):
            ...
            bin_check = 0
            clear_all()
        # Обработка некорректно введённой даты рождения (Меньше текущей даты на 110 лет)
        ...
        # Определяем задание в зависимости от даты рождения
